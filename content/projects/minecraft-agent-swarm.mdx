...
images: ["/projects/swarm-world-aerial.jpg", "/projects/swarm-pillars-and-bridges.jpg", "/projects/swarm-world-overview.jpg", "/projects/swarm-thinking.png", "/projects/swarm-base.png"]
---
...
<a href="/minecraft-advancements" className="my-6 block rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-5 py-4 no-underline transition-colors hover:bg-emerald-500/20">
  <span className="text-lg font-semibold">🏆 The Advancement Ledger</span>
  <span className="mt-1 block text-sm text-muted-foreground">Every achievement the swarm has earned for itself, live from the server — the clearest proof of progress this project has. →</span>
</a>
...
Full breakdown in [Pillars and Bridges to Nowhere](/log/2026-08-05-pillars-and-bridges-to-nowhere).
