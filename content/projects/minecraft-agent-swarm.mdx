...
description: >-
  A self-improving swarm of five local-LLM agents that mine, smelt, farm, build,
  and fight their way through Minecraft as a coordinated team.
category: ai-tools
status: active
...
stars: 24
featured: true
role: Creator · systems architecture · evaluation
...
outcomes:
  ...
  - value: 344k+
    label: measured actions
  - value: '57'
    label: sandboxed Voyager skills
cover: /projects/mineflayer-mission-control.png
images:
  - /projects/swarm-thinking.png
  - /projects/swarm-base.png
---
