...
- **[get-math-done](https://github.com/JesseRWeigel/get-math-done)** — already produced a paper on [chromatic number bounds for random graphs](https://github.com/JesseRWeigel/chromatic-number-random-graphs)
- **get-review-done** — systematic literature reviews
...
- **get-bio-done** — biology research
- **get-policy-done** — policy analysis

These aren't demos or toy projects. The math copilot produced a real paper with LaTeX output and proper citations. The others are at various stages of maturity.
